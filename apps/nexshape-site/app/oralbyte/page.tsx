          ...
          <div className="space-y-10">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-6">
              <Link
                ...
                className="group relative inline-flex items-center justify-center gap-3 overflow-hidden rounded-2xl bg-teal-600 px-10 py-5 text-sm font-black uppercase tracking-widest text-white shadow-[0_0_40px_rgba(20,184,166,0.5)] transition-all hover:bg-teal-500 hover:shadow-[0_0_60px_rgba(20,184,166,0.7)] hover:-translate-y-1 active:scale-95 border border-teal-500/30"
              >
                <div className="absolute inset-0 flex h-full w-full justify-center [transform:skew(-12deg)_translateX(-100%)] group-hover:duration-1000 group-hover:[transform:skew(-12deg)_translateX(100%)]">
                  <div className="relative h-full w-12 bg-white/20" />
                </div>
                <span>Acessar o Sistema OralByte</span>
